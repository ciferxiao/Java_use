...
public class OkhttpManager  {
    ...
    private volatile static OkhttpManager manager;   //防止多个线程访问时
    ...
    public static OkhttpManager getInstance() {
        ...
        if (manager == null) {
            synchronized (OkhttpManager.class) {                //同步代码块
                if(instance == null){
     ...
     * @param callback
     */
    public void asyncJsonStringByURL(String url, final Fun1 callback,Map<String,String> postmap) {
